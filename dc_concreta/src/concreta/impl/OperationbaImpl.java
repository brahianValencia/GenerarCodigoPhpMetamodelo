...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Operationba</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.OperationbaImpl#getName <em>Name</em>}</li>
 *   <li>{@link concreta.impl.OperationbaImpl#getAccessModify <em>Access Modify</em>}</li>
 *   <li>{@link concreta.impl.OperationbaImpl#getRetorno <em>Retorno</em>}</li>
 *   <li>{@link concreta.impl.OperationbaImpl#getClassba <em>Classba</em>}</li>
 *   <li>{@link concreta.impl.OperationbaImpl#getLstParametersba <em>Lst Parametersba</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationbaImpl extends EObjectImpl implements Operationba {
	/**
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.OPERATIONBA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.OPERATIONBA__NAME, oldName, name));
	}
	...
	public void setAccessModify(AccessModifyba newAccessModify) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.OPERATIONBA__ACCESS_MODIFY, oldAccessModify, accessModify));
	}
	...
	public Clasifier getRetorno() {
		if (retorno != null && retorno.eIsProxy()) {
			...
			if (retorno != oldRetorno) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.OPERATIONBA__RETORNO, oldRetorno, retorno));
			}
		}
		return retorno;
	}
	...
	public void setRetorno(Clasifier newRetorno) {
		...
		retorno = newRetorno;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.OPERATIONBA__RETORNO, oldRetorno, retorno));
	}
	...
	public Classba getClassba() {
		if (classba != null && classba.eIsProxy()) {
			...
			if (classba != oldClassba) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.OPERATIONBA__CLASSBA, oldClassba, classba));
			}
		}
		return classba;
	}
	...
	public void setClassba(Classba newClassba) {
		...
		classba = newClassba;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.OPERATIONBA__CLASSBA, oldClassba, classba));
	}
	...
	public EList<Parameter> getLstParametersba() {
		if (lstParametersba == null) {
			lstParametersba = new EObjectContainmentEList<Parameter>(Parameter.class, this, ConcretaPackage.OPERATIONBA__LST_PARAMETERSBA);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConcretaPackage.OPERATIONBA__RETORNO:
				if (resolve) return getRetorno();
				return basicGetRetorno();
			case ConcretaPackage.OPERATIONBA__CLASSBA:
