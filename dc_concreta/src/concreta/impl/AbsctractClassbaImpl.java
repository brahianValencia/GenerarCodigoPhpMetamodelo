...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Absctract Classba</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.AbsctractClassbaImpl#getPath <em>Path</em>}</li>
 *   <li>{@link concreta.impl.AbsctractClassbaImpl#getLstAttributesba <em>Lst Attributesba</em>}</li>
 *   <li>{@link concreta.impl.AbsctractClassbaImpl#getLstMethodba <em>Lst Methodba</em>}</li>
 *   <li>{@link concreta.impl.AbsctractClassbaImpl#getAccessModify <em>Access Modify</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbsctractClassbaImpl extends ClasifierImpl implements AbsctractClassba {
	/**
	 ...
	 * @generated
	 */
	protected AbsctractClassbaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.ABSCTRACT_CLASSBA;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.ABSCTRACT_CLASSBA__PATH, oldPath, path));
	}
	...
	public EList<Attributeba> getLstAttributesba() {
		if (lstAttributesba == null) {
			lstAttributesba = new EObjectContainmentEList<Attributeba>(Attributeba.class, this, ConcretaPackage.ABSCTRACT_CLASSBA__LST_ATTRIBUTESBA);
		}
	...
	public EList<Methodba> getLstMethodba() {
		if (lstMethodba == null) {
			lstMethodba = new EObjectContainmentEList<Methodba>(Methodba.class, this, ConcretaPackage.ABSCTRACT_CLASSBA__LST_METHODBA);
		}
		return lstMethodba;
	}
	...
	public void setAccessModify(AccessModifyba newAccessModify) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.ABSCTRACT_CLASSBA__ACCESS_MODIFY, oldAccessModify, accessModify));
	}
