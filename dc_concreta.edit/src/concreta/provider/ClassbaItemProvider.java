...
/**
 * This is the item provider adapter for a {@link concreta.Classba} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassbaItemProvider extends ClasifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretaPackage.Literals.CLASSBA__PATH,
				 true,
				 false,
				 false,
	...
	protected void addAccessModifyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Classba_accessModify_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Classba_accessModify_feature", "_UI_Classba_type"),
				 ConcretaPackage.Literals.CLASSBA__ACCESS_MODIFY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretaPackage.Literals.CLASSBA__LST_ATTRIBUTESBA);
			childrenFeatures.add(ConcretaPackage.Literals.CLASSBA__LST_METHODBA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.CLASSBA__LST_ATTRIBUTESBA,
				 ConcretaFactory.eINSTANCE.createAttributeba()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.CLASSBA__LST_METHODBA,
