...
public class GeneralizationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canCreateGeneralization_4004(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Generalization newElement = ConcretaFactory.eINSTANCE.createGeneralization();
