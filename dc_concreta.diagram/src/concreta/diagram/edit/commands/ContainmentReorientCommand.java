 ...
 * @generated
 */
public class ContainmentReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ContainmentReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Containment) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistContainment_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected Containment getLink() {
		return (Containment) getElementToEdit();
	}
