 ...
 * @generated
 */
public class AbsctractClassbaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AbsctractClassbaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.AbsctractClassba_2002, getParserElement(),
					ConcretaVisualIDRegistry
							.getType(concreta.diagram.edit.parts.AbsctractClassbaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
