 ...
 * @generated
 */
public class AggregationMultTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AggregationMultTEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AggregationMultTEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Aggregation_4002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AggregationMultTEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationmultTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationmultTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationmultTLabelFigure() {
			this.setText("multT");
		}
