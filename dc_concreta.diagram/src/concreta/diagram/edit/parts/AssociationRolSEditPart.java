 ...
 * @generated
 */
public class AssociationRolSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AssociationRolSEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public AssociationRolSEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationrolSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationrolSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationrolSLabelFigure() {
			this.setText("rolS");
		}
