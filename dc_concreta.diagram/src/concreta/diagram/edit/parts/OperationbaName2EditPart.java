 ...
 * @generated
 */
public class OperationbaName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OperationbaName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Operationba_3006, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.OperationbaName2EditPart.VISUAL_ID));
		}
		return parser;
	}
