 ...
 * @generated
 */
public class MethodbaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodbaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Methodba_3002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MethodbaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
