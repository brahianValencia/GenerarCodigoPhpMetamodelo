 ...
 * @generated
 */
public class InterfaceClassbaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InterfaceClassbaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.InterfaceClassba_2003, getParserElement(),
					ConcretaVisualIDRegistry
							.getType(concreta.diagram.edit.parts.InterfaceClassbaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
