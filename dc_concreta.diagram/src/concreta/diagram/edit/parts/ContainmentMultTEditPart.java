 ...
 * @generated
 */
public class ContainmentMultTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ContainmentMultTEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public ContainmentMultTEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentmultTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentmultTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentmultTLabelFigure() {
			this.setText("multT");
		}
