 ...
 * @generated
 */
public class AssociationMultTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AssociationMultTEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AssociationMultTEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Association_4003, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AssociationMultTEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationmultTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationmultTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationmultTLabelFigure() {
			this.setText("multT");
		}
