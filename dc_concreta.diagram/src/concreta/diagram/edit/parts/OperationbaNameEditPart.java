 ...
 * @generated
 */
public class OperationbaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OperationbaNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Operationba_3006, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.OperationbaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
