...
public class ParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Parameter_3008, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
