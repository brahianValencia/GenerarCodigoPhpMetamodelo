...
import concreta.diagram.edit.policies.Methodba2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Methodba2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Methodba2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Methodba2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MethodbaName2EditPart) {
			((MethodbaName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMethodbaLabelFigure());
			return true;
		}
		if (childEditPart instanceof MethodbaMethodbaLstParametersbaCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getMethodbaLstParametersbaCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((MethodbaMethodbaLstParametersbaCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof MethodbaMethodbaLstParametersbaCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getMethodbaLstParametersbaCompartmentFigure();
			pane.remove(((MethodbaMethodbaLstParametersbaCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof MethodbaMethodbaLstParametersbaCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ConcretaVisualIDRegistry.getType(MethodbaName2EditPart.VISUAL_ID));
	}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ConcretaElementTypes.Parameter_3008) {
				return getChildBySemanticHint(ConcretaVisualIDRegistry
						.getType(MethodbaMethodbaLstParametersbaCompartment2EditPart.VISUAL_ID));
			}
		}
