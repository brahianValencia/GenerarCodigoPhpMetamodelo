 ...
 * @generated
 */
public class AggregationRolTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AggregationRolTEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public AggregationRolTEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationrolTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationrolTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationrolTLabelFigure() {
			this.setText("rolT");
		}
