...
public class InterfaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Interface_2002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.InterfaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
