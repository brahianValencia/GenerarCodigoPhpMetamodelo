 ...
 * @generated
 */
public class AttributebaName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributebaName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Attributeba_3003, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AttributebaName2EditPart.VISUAL_ID));
		}
		return parser;
	}
