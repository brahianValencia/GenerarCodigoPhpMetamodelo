...
import concreta.diagram.edit.policies.ConcretaTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ContainmentMultSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ContainmentMultSEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public ContainmentMultSEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Containment_4001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ContainmentMultSEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ConcretaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentmultSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentmultSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentmultSLabelFigure() {
			this.setText("multS");
		}
