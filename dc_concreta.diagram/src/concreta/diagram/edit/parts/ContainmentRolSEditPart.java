 ...
 * @generated
 */
public class ContainmentRolSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ContainmentRolSEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public ContainmentRolSEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentrolSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentrolSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentrolSLabelFigure() {
			this.setText("rolS");
		}
