 ...
 * @generated
 */
public class AttributebaName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributebaName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Attributeba_3005, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AttributebaName3EditPart.VISUAL_ID));
		}
		return parser;
	}
