 ...
 * @generated
 */
public class AggregationRolSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AggregationRolSEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public AggregationRolSEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationrolSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationrolSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationrolSLabelFigure() {
			this.setText("rolS");
		}
