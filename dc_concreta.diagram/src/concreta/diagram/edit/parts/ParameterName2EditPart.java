 ...
 * @generated
 */
public class ParameterName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Parameter_3009, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ParameterName2EditPart.VISUAL_ID));
		}
		return parser;
	}
