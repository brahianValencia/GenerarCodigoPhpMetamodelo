 ...
 * @generated
 */
public class PackagebaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PackagebaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Packageba_2004, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.PackagebaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
