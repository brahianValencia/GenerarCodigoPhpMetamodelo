 ...
 * @generated
 */
public class AssociationMultSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AssociationMultSEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AssociationMultSEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationmultSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationmultSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationmultSLabelFigure() {
			this.setText("multS");
		}
