 ...
 * @generated
 */
public class ContainmentRolTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ContainmentRolTEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public ContainmentRolTEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentrolTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentrolTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentrolTLabelFigure() {
			this.setText("rolT");
		}
