 ...
 * @generated
 */
public class AggregationMultSEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AggregationMultSEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AggregationMultSEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationmultSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationmultSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationmultSLabelFigure() {
			this.setText("multS");
		}
