 ...
 * @generated
 */
public class AssociationRolTEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.AssociationRolTEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public AssociationRolTEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationrolTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationrolTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationrolTLabelFigure() {
			this.setText("rolT");
		}
