 ...
 * @generated
 */
public class ConcretaViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return DiagramClassbaEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& ConcretaVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ConcretaVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = ConcretaVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ConcretaElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
				...
				if (!DiagramClassbaEditPart.MODEL_ID
						.equals(ConcretaVisualIDRegistry.getModelID(op.getContainerView()))) {
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ConcretaVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != ConcretaVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(DiagramClassbaEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = ConcretaVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ConcretaVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ContainmentEditPart.VISUAL_ID:
			return createContainment_4001(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		case AggregationEditPart.VISUAL_ID:
			return createAggregation_4002(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
	...
	* @generated
	*/
	public Node createClassba_2001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ConcretaVisualIDRegistry.getType(ClassbaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5003 = createLabel(node, ConcretaVisualIDRegistry.getType(ClassbaNameEditPart.VISUAL_ID));
		createCompartment(node,
				ConcretaVisualIDRegistry.getType(ClassbaClassbaLstAttributesbaCompartmentEditPart.VISUAL_ID), true,
				false, true, true);
		createCompartment(node,
				ConcretaVisualIDRegistry.getType(ClassbaClassbaLstMethodbaCompartmentEditPart.VISUAL_ID), true, false,
				true, true);
		return node;
	}
	...
	*/
	public Node createPackageba_2004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ConcretaVisualIDRegistry.getType(PackagebaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createAttributeba_3001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ConcretaVisualIDRegistry.getType(AttributebaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5001 = createLabel(node, ConcretaVisualIDRegistry.getType(AttributebaNameEditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Edge createContainment_4001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ConcretaVisualIDRegistry.getType(ContainmentEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createAggregation_4002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ConcretaVisualIDRegistry.getType(AggregationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	*/
	public Edge createAssociation_4003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ConcretaVisualIDRegistry.getType(AssociationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	* @generated
	*/
	public Edge createGeneralization_4004(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!DiagramClassbaEditPart.MODEL_ID.equals(ConcretaVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", DiagramClassbaEditPart.MODEL_ID); //$NON-NLS-1$
