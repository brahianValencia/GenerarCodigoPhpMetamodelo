 ...
 * @generated
 */
public class ConcretaDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	* @generated
	*/
	public static final String ID = "dc_concreta.diagram"; //$NON-NLS-1$
	...
	* @generated
	*/
	private static ConcretaDiagramEditorPlugin instance;
	...
	* @generated
	*/
	private ConcretaDocumentProvider documentProvider;
	...
	* @generated
	*/
	public ConcretaDiagramEditorPlugin() {
	}
	...
	* @generated
	*/
	public static ConcretaDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	*/
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories.add(new ConcretaItemProviderAdapterFactory());
	...
	* @generated
	*/
	public ConcretaDocumentProvider getDocumentProvider() {
