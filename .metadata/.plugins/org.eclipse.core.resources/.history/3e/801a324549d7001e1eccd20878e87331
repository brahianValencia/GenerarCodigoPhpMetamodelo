 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.ClasifierImpl#getName <em>Name</em>}</li>
 *   <li>{@link abstracta.impl.ClasifierImpl#getLstAttributebaC <em>Lst Attributeba C</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClasifierImpl extends EObjectImpl implements Clasifier {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.CLASIFIER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CLASIFIER__NAME, oldName, name));
	}
	...
	public EList<Attributeba> getLstAttributebaC() {
		if (lstAttributebaC == null) {
			lstAttributebaC = new EObjectResolvingEList<Attributeba>(Attributeba.class, this, AbstractaPackage.CLASIFIER__LST_ATTRIBUTEBA_C);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractaPackage.CLASIFIER__NAME:
				return getName();
			case AbstractaPackage.CLASIFIER__LST_ATTRIBUTEBA_C:
