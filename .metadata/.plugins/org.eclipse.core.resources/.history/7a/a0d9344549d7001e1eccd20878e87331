 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.PackagebaImpl#getName <em>Name</em>}</li>
 *   <li>{@link abstracta.impl.PackagebaImpl#getPath <em>Path</em>}</li>
 *   <li>{@link abstracta.impl.PackagebaImpl#getListPackages <em>List Packages</em>}</li>
 *   <li>{@link abstracta.impl.PackagebaImpl#getLstClass <em>Lst Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackagebaImpl extends EObjectImpl implements Packageba {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.PACKAGEBA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.PACKAGEBA__NAME, oldName, name));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.PACKAGEBA__PATH, oldPath, path));
	}
	...
	public EList<Packageba> getListPackages() {
		if (listPackages == null) {
			listPackages = new EObjectContainmentEList<Packageba>(Packageba.class, this, AbstractaPackage.PACKAGEBA__LIST_PACKAGES);
		}
		return listPackages;
	}
	...
	public EList<Classba> getLstClass() {
		if (lstClass == null) {
			lstClass = new EObjectContainmentEList<Classba>(Classba.class, this, AbstractaPackage.PACKAGEBA__LST_CLASS);
		}
		return lstClass;
	}
